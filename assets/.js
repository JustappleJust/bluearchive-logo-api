...
const Y = {
        canvasHeight: 250,
        canvasWidth: 900,
        fontFamily: "RoGSanSrfStd-Bd, GlowSansSC-Normal-Heavy_diff, Gyeonggi_Bold, GyeonggiTitle",
        fontSize: 84,
        subfontSize: 32,
        fontWeight: 700,
        textBaseLine: .68,
...
const {canvasHeight: R, canvasWidth: D, fontFamily: Ne, fontSize: gt, subfontSize: dt, fontWeight: Pe, horizontalTilt: H, textBaseLine: I, graphOffset: ie, paddingX: z, hollowPath: J} = Y,
    ...
    pt = `${Pe} ${dt}px ${Ne}, apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, PingFang SC, Hiragino Sans GB, Microsoft YaHei, sans-serif`;
class mt {
    constructor()
    {
        w(this, "canvas");
...
//      })
    ...
    {
        let e;
        return e = document.createElement("canvas"), e.width = this.textWidthL + this.textWidthR + z * 2, e.height = this.canvas.height, e.getContext("2d").drawImage(this.canvas, this.canvasWidthL - this.textWidthL - z, 0, e.width, e.height, 0, 0, e.width, e.height), new Promise((n, i) => {
            e.toBlob(r => r ? n(r) : i())
        })
    }
    saveImg()
...
const bt = "ba-logo/assets/halo.png",
    yt = "ba-logo/assets/cross.png",
